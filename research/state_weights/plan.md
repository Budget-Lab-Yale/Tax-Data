...
- **2026-09-11** — The workstream moved to **Tax-Data** (this copy is the live
  ...
  consumer's weights (was 38.26M vs 41.23M non-filer adults at 2023). S21
  proposed in the decisions log: one universe for every year of the partition.
  HT2 TY2023 landed, so both ceilings are 2023. Block E's architecture collision
  is documented in the review brief (artifact "The Non-Filer Handoff").
